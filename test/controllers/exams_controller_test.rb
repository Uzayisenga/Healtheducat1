...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { attempty: @exam.attempty, course_id: @exam.course_id, marks: @exam.marks, users_id: @exam.users_id } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { attempty: @exam.attempty, course_id: @exam.course_id, marks: @exam.marks, users_id: @exam.users_id } }
